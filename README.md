...
One of the most helpful features of a database is that it will track whether values inside the database have been changed. For example, consider a system that tracks whether the user has seen various screens for the purposes of showing tutorials.

&nbsp;

## Addendum: Saving And Loading Databases
